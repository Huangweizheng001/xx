	...
	w.CHAT = {
				...
				if(obj.type == 'content') {
					if((obj.userType != '1') && (obj.userType != 1) && (obj.userType != '3') && (obj.userType != 3)) {
						...
						switch(obj.userGrade) {
							case 0: //普通会员
								section.innerHTML = '<div class="clearfix dycordinary"><span class="dycadmin dycadmin-ordinary" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							case 1: //白银
								section.innerHTML = '<div class="clearfix dycsilver"><span class="dycadmin dycadmin-silver" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							case 2: //黄金
								section.innerHTML = '<div class="clearfix dycgold"><span class="dycadmin dycadmin-gold" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							case 3: //钻石
								section.innerHTML = '<div class="clearfix dycdiamond"><span class="dycadmin dycadmin-diamond" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							case 4: //专属
								section.innerHTML = '<div class="clearfix dycexclusive"><span class="dycadmin dycadmin-exclusive" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							case 5: //专属
								section.innerHTML = '<div class="clearfix dycexclusive"><span class="dycadmin dycadmin-exclusive" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
								break;
							...
							default: //游客
								...
								section.innerHTML = '<div class="clearfix"><span class="dycadmin" style="background-image:url(../ycedu/images/grader.png)" onclick="CHAT.addGroup(' + obj.userid + ',\'' + obj.username + '\');"></span>' + usernameDiv + obj.content + '</div>';
						}
		...
		submitMessage: function(obj, type) { //type = 1 : local 
			...
			if((obj.userType != '1') && (obj.userType != 1) && (obj.userType != '3') && (obj.userType != 3)) {
				...
				var section = d.createElement('div');
				if(type == 1) {
					section.className = 'dycdiscuss-box ycmessage' + obj.subTime + ' ycmessageold' + obj.subTime;section.className = 'dycdiscuss-box-admin clearfix ycmessage' + obj.subTime + ' ycmessageold' + obj.subTime;
				} else {
					section.className = 'dycdiscuss-box-admin clearfix ycmessage' + obj.subTime;
				}
				section.innerHTML = usernameImg + '<div class="dycadmin-box dycanchor-box dyc"><div class="dycadmin dycadmin-admin"></div>' + usernameDiv + obj.content + '</div>';
				...
				if(res.length < 1) {
					...
					$("#dbLivePlayer").on("click",function(){
						layer.open({
							...
							area: ['400px', '680px'],
							content: './yh/yhpay.html?from=yhlive'
						});
					})
					clientIp(mid);
					return false;
