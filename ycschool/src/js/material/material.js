require("../../css/material/material.less");
	...
	new Vue({
	    ...
	    methods:{
	    	getFilter(subject,grade,semester,type){
	    		var _this = this;
	    		_this.getSubject(subject,grade,semester,type)
        		//类别
	    	...
	    	getCourse(){
	    		var _this = this;
	    		this.$http.post(SERVERROOTDATA+"/website/ashx/site/TeachingMaterial.ashx?action=getTeachingMaterial", {
	    			//name:'',
