	...
	w.CHAT = {
		...
		submit: function(type, eleObj) {
			...
			if(content != '') {
				...
				//				$.ajax({
				//					type: "POST",
				//					url: ROUTE + "ChannelEvaluation.ashx?action=evaluation",
				//					dataType: "json",
				//					data: {
				//						"memberId": $mid,
				//						"channelId": id,
		...
		//点击打赏时插入实时打赏消息
		cost: function($rgoods, $obType, $num, $obj, userGrade) {
			var obj = {
				type: 'cost',
				username: this.username,
				userImg: this.userImg,
				...
				for(var i = 0; i < obj.length; i++) {
					if(obj[i].type == 'content') {
						...
						switch(obj[i].userGrade) {
							case 0: //普通会员
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-ordinary" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
							case 1: //白银
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-silver" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
							case 2: //黄金
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-gold" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
							case 3: //钻石
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-diamond" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
							case 4: //专属
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-exclusive" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
							case 5: //专属
								section.innerHTML = '<div class="clearfix"><span class="dycadmin dycadmin-exclusive" style="background-image:url(' + obj[i].userImg + ')"></span>' + usernameDiv + obj[i].content + '</div>';
								break;
						...
						switch(obj[i].userGrade) {
							case 0: //普通会员
								html += '<span class="grader grader-ordinary" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 1: //白银
								html += '<span class="grader grader-silver" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 2: //黄金
								html += '<span class="grader grader-gold" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 3: //钻石
								html += '<span class="grader grader-diamond" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 4: //专属
								html += '<span class="grader grader-exclusive"" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 5: //专属
								html += '<span class="grader grader-exclusive"" style="background-image:url(' + obj[i].userImg + ')"></span>';
								break;
							case 6: //专属
								...
								break;
							default: //游客
								html += '<span class="grader" style="background-image:url(' + obj[i].userImg + ')">></span>';
						}
